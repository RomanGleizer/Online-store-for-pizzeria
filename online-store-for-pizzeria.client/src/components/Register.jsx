...
function Register() {
  return (
    <div className="reg-cont">
      <div>
      <div className="regi">Впервые у нас? Зарегистрируйтесь!
</div>
      <div className="user-cont">
        <p className="email-name r-p">Напишите ваше имя</p>
        <input placeholder="Ваше имя" className="email-input l-input no-radio" required/>
      </div>
      ...
      <div className="password">
        ...
        <input placeholder="Ваш пароль" type="password" className="password-input no-radio l-input" />
      </div>

      <div className="mobile">
        <p className="mobile-name r-p">И напишите телефончик :)</p>
        <input placeholder="+79000000000" type="phone" className="mobile-input no-radio l-input" />
      </div>
